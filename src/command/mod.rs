...
impl Command {
    pub fn get_args(&self) -> Vec<CString> {
        self.tokens
            .iter()
            .map(|token| {
...
//    pub fn parse_input(
//        input_str: String,
//    ) -> anyhow::Result<(Vec<DeprecatedCommand>, Vec<Separator>)> {
...
//                let parse_result = DeprecatedCommand::parse_cmd_str_vec(command_strs.clone());
//                match parse_result {
//                    Ok(command) => {
...
//                let result = DeprecatedCommand::parse_input(subshell_input.clone() + "\n");
//                match result {
...
//    pub fn parse_cmd_str_vec(mut args_with_cmd: Vec<String>) -> anyhow::Result<DeprecatedCommand> {
...
//        let mut command = DeprecatedCommand {
//            path: cmd_path.clone(),
//            args: args_with_cmd
//                .iter()
//                .enumerate()
...
// #[cfg(test)]
// mod tests {
//     use super::{DeprecatedCommand, Separator};

//     // Following matklad's `check` pattern, ref:
//     // https://matklad.github.io/2021/05/31/how-to-test.html
//     fn check(input_str: &str) -> (Vec<DeprecatedCommand>, Vec<Separator>) {
//         return DeprecatedCommand::parse_input(input_str.to_string() + "\n")
